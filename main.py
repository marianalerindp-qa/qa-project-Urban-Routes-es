...
class UrbanRoutesPage:
    ...
    reqs_manta_y_pañuelos = (By.XPATH, "//div[contains(text(), 'Manta y pañuelos')]//span[@class='slider round']")
    ...
    def click_reqs_manta(self):
        self.driver.find_element(*self.reqs_manta_y_pañuelos).click()
...
class TestUrbanRoutes:
    ...
    def reserve_taxi_conmfort(self):
        routes_page = UrbanRoutesPage(self.driver)
    ...
    def   test_add_pay(self):
        routes_page = UrbanRoutesPage(self.driver)
        routes_page.new_card()
        assert routes_page.new_card() == data.card_number
        assert routes_page.new_code() == data.card_code
